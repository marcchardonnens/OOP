...
public abstract class AElement implements Comparable<AElement>{

    protected final short periodicNumber;
    protected final Temperatur tempMeltingPoint;
    protected final Temperatur tempBoilingPoint;
    protected final String shortName;

    protected AElement(short periodicNumber, Temperatur tempMeltingPoint, Temperatur tempBoilingPoint, String shortName) {
    ...
    public final boolean equals(Object o) {
        ...
        return  Objects.equals(periodicNumber, aElement.periodicNumber) &&
                Objects.equals(getTempMeltingPoint(), aElement.getTempMeltingPoint()) &&
    ...
    public final int hashCode() {
        return Objects.hash(periodicNumber, getTempMeltingPoint(), getTempBoilingPoint(), shortName);
    }
     ...
     */
    @Override
    public int compareTo(@NotNull AElement o) {
        return Short.compare(periodicNumber, o.periodicNumber);
    }
}
